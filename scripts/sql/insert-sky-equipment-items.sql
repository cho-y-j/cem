-- 스카이장비 템플릿 항목 삽입
-- 템플릿 ID: bUKZFg1nv4gklE9tceuak

-- 일일점검 항목
INSERT INTO safety_inspection_template_items (id, template_id, category, item_text, check_frequency, check_timing, result_type, display_order, is_required, created_at) VALUES
