...
export default function MobileLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50 safe-area-inset">
      ...
      {/* 메인 컨텐츠 - 모바일 최적화 */}
      <main className={cn(showBottomNav && "safe-area-content-bottom")}>
        {children}
      </main>

      {/* 하단 네비게이션 (Worker 전용) - 모바일 최적화 */}
      {showBottomNav && (
        <nav className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-50 safe-area-nav-bottom max-w-md mx-auto">
